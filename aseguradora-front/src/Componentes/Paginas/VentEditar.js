...
export default function VentEditar ( ) {
  ...
  return (
    <div>
    <h2>Editar informacion de repuestos</h2>
    <Form.Item style={{width:'100%'}}>
      ...
      <Flex>
      <Button type='primary' style={{width: '30%', marginBottom: '3%', backgroundColor: '#0B164F'}} onClick={showModal}>Editar Registro</Button>
      <Modal title="Editar" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
        <p>Registro editado</p>
      </Modal>
    </Flex>
    </div>
  )
